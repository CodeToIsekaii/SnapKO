      ...
      <div className="relative">
        ...
        <AnimatePresence>
          {isDropdownOpen && (
            ...
            >
              <button className="flex items-center gap-3 w-full px-4 py-3 hover:bg-[#FAF9F7] text-left transition-colors border-b border-[#E0DCD5]/50 group">
                <svg
              ...
              <button className="flex items-center gap-3 w-full px-4 py-3 hover:bg-[#FAF9F7] text-left transition-colors group">
                <svg
